...
{
	public class SchoolCertificateDocumentEditorViewModel : ViewModelBase
	{
		/* ****************************************************************************
		 * 
		...
		public SchoolCertificateDocumentEditorViewModel(SchoolCertificateDocument document)
		{
		...
		SchoolCertificateDocument _doc;

		public SchoolCertificateDocument Document
		{
			get
			{		
				return _doc;

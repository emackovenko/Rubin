...
namespace Model.Astu.Orders.History
{
    /// <summary>
    /// Приказ о выходе студента из отпуска по беременности и родам/уходу за ребенком
    /// </summary>
    public class ChildrenFussVacationExitOrder: StudentOrderBase
    {
        public ChildrenFussVacationExitOrder() : base ()
        {
            OrderTypeId = "0029";
            Comment = "Выход из отпуска с ";
        }
